...
public class BattleFloor implements Room{
    ...
    /**
     * Creates a list of NPCs(enemies in this) that holds all NPCs on the floor
     */
    public void genNPCs(){
    ...
    /**
     * Prints out the description of the battle floor
     */
    public void roomDes(){
    ...
    /**
     * Prints out the response from talking to an NPC.
     */
    ...
    /**
     * Attacks the enemy that the user chooses.
     * @param input : the Scanner that reads user input.
     */
    ...
    /**
     * Generates the enemy's attack on the player
     * @param hp : the amount of health before the attacks
     * @returns the player's remaining hp.
     */
    ...
    /**
     * @returns the number of enemies left on this floor.
     */
    ...
    /**
     * Prints out the description of an NPC
     */
    ...
    /**
     * creates a list of enemies in this room.
     * @param num : the number of enemies
