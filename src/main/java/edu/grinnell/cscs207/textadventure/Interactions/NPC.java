...
public class NPC implements interactable{
        ...
        if(friendly && isShopkeep){
            ...
            while(scan.hasNext()){
                ...
                if(str.equals("yes") || str.equals("y")){
                    ...
                    System.out.println("You are now the proud owner of a " + selling.getTitle() + ". Congrats!");
                    return selling;
                }else if(str.equals("no") || str.equals("n")){
            ...
            System.out.println("Climber: Why have you come to this place? For fame, fortune, or fun?");
             while(scan.hasNext()){
                str = scan.next().toLowerCase();
                if(str.equals("fame")){
    ...
    public void fillGifts(){
        gifts.add("Stick", "Its a stick. For some reason it was special to someone.", false);
        gifts.add("Leather Bracelet", "Its a worn bracelet with the words 'May your judgement be wise' engraved upon it.", false);
        gifts.add("Weird Rock", "It really is a weird rock. You can throw it at people, but why would you want to?", true);
    }
